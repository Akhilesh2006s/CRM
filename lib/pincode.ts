...
/** Same-origin Next.js proxy (server handles expired India Post TLS cert). */
...
/** Next proxy first (Vercel), then CRM backend. No browser call to postalpincode.in (cert expired). */
