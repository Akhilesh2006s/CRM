...
export default function CloseLeadPage() {
  ...
  const handleTurnToClient = async () => {
    ...
    try {
      ...
      const assignedEmployeeId = currentUser._id // Always use current user who is converting the lead
      ...
      const updatePayload: any = {
        ...
        assigned_to: assignedEmployeeId, // Ensure lead is assigned to current employee
      ...
      // Convert selected products to productDetails format for DC
      const productDetails = selectedProducts.map(product => ({
        product: product,
        class: '1', // Default class
        category: 'New Students', // Default category
        productName: product, // Use product name
        quantity: 1, // Default quantity
        strength: 0, // Will be filled later
        price: 0, // Will be filled later
        total: 0, // Will be calculated later
        level: 'L2', // Default level
      }))
      ...
      const dcPayload: any = {
        ...
        productDetails: productDetails, // Save selected products to DC productDetails
      }
      ...
      toast.success('Lead converted to client! DC created successfully. It will appear in Client DC page.')
